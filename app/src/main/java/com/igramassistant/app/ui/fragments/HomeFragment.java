...
import com.igramassistant.app.binding.HomeViewModel;
import com.igramassistant.app.binding.NotificationsViewModel;
...
import com.igramassistant.app.views.sparkbutton.SparkButton;
...
//                        notifAction.setCompoundDrawables(ResourceUtils.getDrawable(R.drawable.ic_notifications_black_24dp),null,null,null);
    ...
    private void setUpActionList(List<ActionItem> actionList) {
        ...
        listItems.setLayoutManager(new GridLayoutManager(getContext(), 2));
